...
const setState = (state, content) => {
  try {
    state.GeometryList = [...content.data.geometries];
    state.FluxList = [...content.data.flux];
    state.SourcesList = [...content.data.sources];
    state.title = content.data.title;
    state.description = content.data.description;
    state.scene_design = content.data.scene_design;
    state.scene_simulation = content.data.scene_simulation;
    state.movie = content.data.movie;
    state.id = content.data._id;
    state.author = content.data.author;
    state.productions = content.data.productions;
    state.coordinates = content.data.coordinates;
    state.resolution = content.data.resolution;
    state.plotOptions = content.data.plotOptions;
    setCoordinates(state, content.data.coordinates);
  } catch (err) {
    Swal.fire({
